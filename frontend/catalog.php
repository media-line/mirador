...
<main class="main">
	...
	<div class="page catalog">
		...
		<div class="uk-container uk-container-center">
			<div class="category_list uk-grid">

				<div class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3 uk-width-large-1-4 margin-top-30">
					<div class="category_list-item uk-position-relative">
						<div class="category_list-item-holder uk-position-absolute">
							<a class="category_list-item-image uk-cover-background uk-flex uk-flex-middle uk-flex-center uk-overflow-hidden" href="#">
								<img src="images/catalog/category001.jpg" alt="">
							</a>

							<div class="category_list-item-name text-purple h3 text-vollkorn uk-text-center
							margin-top-medium">
								<a class="text-purple" href="#">Двери</a>
							</div>

							<div class="category_list-item-additional margin-top-medium">
								<div class="category_list-item-description text-muted text-medium uk-overflow-hidden">
									Здесь будет написано краткое описание категории с преимуществами дверей данной категории
								</div>
								<a href="#" class="button button-full_width margin-top-medium">Перейти в раздел</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3 uk-width-large-1-4 margin-top-30">
					<div class="category_list-item uk-position-relative">
						<div class="category_list-item-holder uk-position-absolute">
							<a class="category_list-item-image uk-cover-background uk-flex uk-flex-middle uk-flex-center uk-overflow-hidden" href="#">
								<img src="images/catalog/category002.jpg" alt="">
							</a>

							<div class="category_list-item-name text-purple h3 text-vollkorn uk-text-center
							margin-top-medium">
								<a class="text-purple" href="#">Перегородки</a>
							</div>
				...
				<div class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3 uk-width-large-1-4 margin-top-30">
					<div class="category_list-item uk-position-relative">
						<div class="category_list-item-holder uk-position-absolute">
							<a class="category_list-item-image uk-cover-background uk-flex uk-flex-middle uk-flex-center uk-overflow-hidden" href="#">
								<img src="images/catalog/category003.jpg" alt="">
							</a>

							<div class="category_list-item-name text-purple h3 text-vollkorn uk-text-center
							margin-top-medium">
								<a class="text-purple" href="#">Фасады</a>
							</div>
				...
				<div class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3 uk-width-large-1-4 margin-top-30">
					<div class="category_list-item uk-position-relative">
						<div class="category_list-item-holder uk-position-absolute">
							<a class="category_list-item-image uk-cover-background uk-flex uk-flex-middle uk-flex-center uk-overflow-hidden" href="#">
								<img src="images/catalog/category004.jpg" alt="">
							</a>

							<div class="category_list-item-name text-purple h3 text-vollkorn uk-text-center
							margin-top-medium">
								<a class="text-purple" href="#">Экраны на радиатор</a>
							</div>
				...
				<div class="category_list-separator uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3
				uk-width-large-1-4 margin-top-30">
				</div>

				<div class="uk-width-1-1 uk-width-small-1-2 uk-width-medium-1-3 uk-width-large-2-4 margin-top-30">
					<div class="category_list-item uk-position-relative">
						<div class="category_list-item-holder uk-position-absolute">
							<a class="category_list-item-image uk-cover-background uk-flex uk-flex-middle uk-flex-center uk-overflow-hidden" href="#">
								<img src="images/catalog/category005.jpg" alt="">
							</a>

							<div class="category_list-item-name text-purple h3 text-vollkorn uk-text-center
							margin-top-medium">
								<a class="text-purple" href="#">Домовая резьба</a>
							</div>
